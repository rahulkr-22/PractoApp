        ...
        <div className='flex flex-row justify-center mt-20'>
            <div className='flex flex-col w-1/4 divide-y-2 divide-gray-200 text-gray-700 bg-white rounded shadow-md'>
                ...
                <div className='flex flex-row justify-around items-center h-20 p-4'>
                    <IoMdCalendar />
                    <div>On <span className='font-semibold mr-36'>{getDate()}</span></div>
                    <FiClock />
                    <div className='font-semibold'>At {timeSlot}</div>
                </div>
                <div className='flex flex-row justify-around p-4'>
                    <img className='w-24 h-24' src={bookData.image_url} alt="Doctor" />
                    <div className='ml-10'>
                        <p className='font-semibold'>{bookData.doctorName}</p>
                        <p>BDS, MDS - Orthodontics Orthodontist, Implantologist, Dentist, Dental Surgeon</p>
                    </div>
                </div>
                <div className='flex flex-row justify-around p-4'>
                    <img className='w-24 h-24' src='https://images1-fabric.practo.com/practices/1163292/excel-dental-care-bangalore-5a03f54887a09.jpeg' alt="Clinic" />
                    <div>
            ...
            <div className='flex flex-col justify-start gap-4 ml-10 p-2 text-gray-700'>
                ...
                <div className='flex flex-row gap-x-9 mt-4 ml-4'>
                    ...
                    <button className="bg-sky-400 text-white font-semibold rounded p-1 px-2 hover:bg-sky-500" onClick={handleClickHome}>
                        Back To Home
                    </button>
                </div>
            </div>
