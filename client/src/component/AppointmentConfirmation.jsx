        ...
        <div className='flex flex-row justify-center mt-20 '>
            ...
            <div className='flex flex-col justify-start gap-4 ml-10 p-2 text-gray-700'>
                ...
                <div className='flex flex-row gap-x-9'>
                    <button className='border-2 border-sky-300 rounded p-1 px-2 text-sky-400 font-medium' onClick={handleClickCancel}>Cancel Appointment</button>
                    <button className='border-2 border-sky-300 rounded p-1 px-2 text-sky-400 font-medium' onClick={handleClickHome}>Back To Home</button>
                </div>
            </div>
        </div>
    )
